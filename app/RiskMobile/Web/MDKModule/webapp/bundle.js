...
/***/ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_Cancel.js":
/*!******************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_Cancel.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_CreateEntity.js":
/*!************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_CreateEntity.js ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_CreateRisks.js":
/*!***********************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_CreateRisks.js ***!
  \***********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function CreateRelatedEntity(clientAPI) {
    if (clientAPI.getODataProvider('/RiskMobile/Services/service1.service').isDraftEnabled('Mitigations')) {
        ...
        return clientAPI.executeAction({
            'Name': '/RiskMobile/Actions/Mitigations/Mitigations_CreateRisks.action',
            'Properties': {
                'OnSuccess': ''
            }
        }).then((result) => {
        ...
        return clientAPI.executeAction('/RiskMobile/Actions/Mitigations/Mitigations_CreateRisks.action');
    }
}

/***/ }),

/***/ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_DeleteConfirmation.js":
/*!******************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_DeleteConfirmation.js ***!
  \******************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RiskMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RiskMobile/Actions/Mitigations/Mitigations_DeleteEntity.action').then(
...
/***/ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_UpdateEntity.js":
/*!************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_UpdateEntity.js ***!
  \************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function UpdateEntity(clientAPI) {
    if (clientAPI.getODataProvider('/RiskMobile/Services/service1.service').isDraftEnabled('Mitigations')) {
        return clientAPI.executeAction({
            'Name': '/RiskMobile/Actions/Mitigations/Mitigations_UpdateEntity.action',
            'Properties': {
                'OnSuccess': ''
            }
        }).then((result) => {
        ...
        return clientAPI.executeAction('/RiskMobile/Actions/Mitigations/Mitigations_UpdateEntity.action');
    }
}

/***/ }),

/***/ "./build.definitions/RiskMobile/Rules/Mitigations/NavToMitigations_CreateRisks.js":
/*!****************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Mitigations/NavToMitigations_CreateRisks.js ***!
  \****************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/Mitigations/NavToMitigations_Edit.js":
/*!*********************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Mitigations/NavToMitigations_Edit.js ***!
  \*********************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/Risks/NavToRisks_Edit.js":
/*!*********************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Risks/NavToRisks_Edit.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    if (clientAPI.getODataProvider('/RiskMobile/Services/service1.service').isDraftEnabled('Risks')) {
        return clientAPI.executeAction({
            ...
            'Properties': {
                ...
                'OnSuccess': '/RiskMobile/Actions/Risks/NavToRisks_Edit.action'
            }
        });
    } else {
        return clientAPI.executeAction('/RiskMobile/Actions/Risks/NavToRisks_Edit.action');
    }
}

/***/ }),

/***/ "./build.definitions/RiskMobile/Rules/Risks/Risks_Cancel.js":
/*!******************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Risks/Risks_Cancel.js ***!
  \******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/Risks/Risks_CreateEntity.js":
/*!************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Risks/Risks_CreateEntity.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./build.definitions/RiskMobile/Rules/Risks/Risks_DeleteConfirmation.js":
/*!******************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Risks/Risks_DeleteConfirmation.js ***!
  \******************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function DeleteConfirmation(clientAPI) {
    return clientAPI.executeAction('/RiskMobile/Actions/DeleteConfirmation.action').then((result) => {
        if (result.data) {
            return clientAPI.executeAction('/RiskMobile/Actions/Risks/Risks_DeleteEntity.action').then(
                (success) => Promise.resolve(success),
                (failure) => Promise.reject('Delete entity failed ' + failure));
        } else {
            return Promise.reject('User Deferred');
...
/***/ "./build.definitions/RiskMobile/Rules/Risks/Risks_UpdateEntity.js":
/*!************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Rules/Risks/Risks_UpdateEntity.js ***!
  \************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let riskmobile_actions_mitigations_mitigations_createentity_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/Mitigations_CreateEntity.action */ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_CreateEntity.action")
let riskmobile_actions_mitigations_mitigations_createrisks_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/Mitigations_CreateRisks.action */ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_CreateRisks.action")
let riskmobile_actions_mitigations_mitigations_deleteentity_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/Mitigations_DeleteEntity.action */ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_DeleteEntity.action")
let riskmobile_actions_mitigations_mitigations_detailpopover_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/Mitigations_DetailPopover.action */ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_DetailPopover.action")
let riskmobile_actions_mitigations_mitigations_updateentity_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/Mitigations_UpdateEntity.action */ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_UpdateEntity.action")
let riskmobile_actions_mitigations_navtomitigations_create_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/NavToMitigations_Create.action */ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Create.action")
let riskmobile_actions_mitigations_navtomitigations_createrisks_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/NavToMitigations_CreateRisks.action */ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_CreateRisks.action")
let riskmobile_actions_mitigations_navtomitigations_detail_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/NavToMitigations_Detail.action */ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Detail.action")
let riskmobile_actions_mitigations_navtomitigations_edit_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/NavToMitigations_Edit.action */ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Edit.action")
let riskmobile_actions_mitigations_navtomitigations_list_action = __webpack_require__(/*! ./RiskMobile/Actions/Mitigations/NavToMitigations_List.action */ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_List.action")
let riskmobile_actions_risks_navtorisks_create_action = __webpack_require__(/*! ./RiskMobile/Actions/Risks/NavToRisks_Create.action */ "./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Create.action")
let riskmobile_actions_risks_navtorisks_detail_action = __webpack_require__(/*! ./RiskMobile/Actions/Risks/NavToRisks_Detail.action */ "./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Detail.action")
let riskmobile_actions_risks_navtorisks_edit_action = __webpack_require__(/*! ./RiskMobile/Actions/Risks/NavToRisks_Edit.action */ "./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Edit.action")
let riskmobile_actions_risks_navtorisks_list_action = __webpack_require__(/*! ./RiskMobile/Actions/Risks/NavToRisks_List.action */ "./build.definitions/RiskMobile/Actions/Risks/NavToRisks_List.action")
let riskmobile_actions_risks_risks_createentity_action = __webpack_require__(/*! ./RiskMobile/Actions/Risks/Risks_CreateEntity.action */ "./build.definitions/RiskMobile/Actions/Risks/Risks_CreateEntity.action")
let riskmobile_actions_risks_risks_deleteentity_action = __webpack_require__(/*! ./RiskMobile/Actions/Risks/Risks_DeleteEntity.action */ "./build.definitions/RiskMobile/Actions/Risks/Risks_DeleteEntity.action")
let riskmobile_actions_risks_risks_updateentity_action = __webpack_require__(/*! ./RiskMobile/Actions/Risks/Risks_UpdateEntity.action */ "./build.definitions/RiskMobile/Actions/Risks/Risks_UpdateEntity.action")
let riskmobile_actions_service_initializeonline_action = __webpack_require__(/*! ./RiskMobile/Actions/Service/InitializeOnline.action */ "./build.definitions/RiskMobile/Actions/Service/InitializeOnline.action")
let riskmobile_actions_service_initializeonlinefailuremessage_action = __webpack_require__(/*! ./RiskMobile/Actions/Service/InitializeOnlineFailureMessage.action */ "./build.definitions/RiskMobile/Actions/Service/InitializeOnlineFailureMessage.action")
let riskmobile_actions_service_initializeonlinesuccessmessage_action = __webpack_require__(/*! ./RiskMobile/Actions/Service/InitializeOnlineSuccessMessage.action */ "./build.definitions/RiskMobile/Actions/Service/InitializeOnlineSuccessMessage.action")
...
let riskmobile_pages_mitigations_mitigations_create_page = __webpack_require__(/*! ./RiskMobile/Pages/Mitigations/Mitigations_Create.page */ "./build.definitions/RiskMobile/Pages/Mitigations/Mitigations_Create.page")
let riskmobile_pages_mitigations_mitigations_createrisks_page = __webpack_require__(/*! ./RiskMobile/Pages/Mitigations/Mitigations_CreateRisks.page */ "./build.definitions/RiskMobile/Pages/Mitigations/Mitigations_CreateRisks.page")
let riskmobile_pages_mitigations_mitigations_detail_page = __webpack_require__(/*! ./RiskMobile/Pages/Mitigations/Mitigations_Detail.page */ "./build.definitions/RiskMobile/Pages/Mitigations/Mitigations_Detail.page")
let riskmobile_pages_mitigations_mitigations_edit_page = __webpack_require__(/*! ./RiskMobile/Pages/Mitigations/Mitigations_Edit.page */ "./build.definitions/RiskMobile/Pages/Mitigations/Mitigations_Edit.page")
let riskmobile_pages_mitigations_mitigations_list_page = __webpack_require__(/*! ./RiskMobile/Pages/Mitigations/Mitigations_List.page */ "./build.definitions/RiskMobile/Pages/Mitigations/Mitigations_List.page")
let riskmobile_pages_risks_risks_create_page = __webpack_require__(/*! ./RiskMobile/Pages/Risks/Risks_Create.page */ "./build.definitions/RiskMobile/Pages/Risks/Risks_Create.page")
let riskmobile_pages_risks_risks_detail_page = __webpack_require__(/*! ./RiskMobile/Pages/Risks/Risks_Detail.page */ "./build.definitions/RiskMobile/Pages/Risks/Risks_Detail.page")
let riskmobile_pages_risks_risks_edit_page = __webpack_require__(/*! ./RiskMobile/Pages/Risks/Risks_Edit.page */ "./build.definitions/RiskMobile/Pages/Risks/Risks_Edit.page")
let riskmobile_pages_risks_risks_list_page = __webpack_require__(/*! ./RiskMobile/Pages/Risks/Risks_List.page */ "./build.definitions/RiskMobile/Pages/Risks/Risks_List.page")
...
let riskmobile_rules_mitigations_mitigations_cancel_js = __webpack_require__(/*! ./RiskMobile/Rules/Mitigations/Mitigations_Cancel.js */ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_Cancel.js")
let riskmobile_rules_mitigations_mitigations_createentity_js = __webpack_require__(/*! ./RiskMobile/Rules/Mitigations/Mitigations_CreateEntity.js */ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_CreateEntity.js")
let riskmobile_rules_mitigations_mitigations_createrisks_js = __webpack_require__(/*! ./RiskMobile/Rules/Mitigations/Mitigations_CreateRisks.js */ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_CreateRisks.js")
let riskmobile_rules_mitigations_mitigations_deleteconfirmation_js = __webpack_require__(/*! ./RiskMobile/Rules/Mitigations/Mitigations_DeleteConfirmation.js */ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_DeleteConfirmation.js")
let riskmobile_rules_mitigations_mitigations_updateentity_js = __webpack_require__(/*! ./RiskMobile/Rules/Mitigations/Mitigations_UpdateEntity.js */ "./build.definitions/RiskMobile/Rules/Mitigations/Mitigations_UpdateEntity.js")
let riskmobile_rules_mitigations_navtomitigations_createrisks_js = __webpack_require__(/*! ./RiskMobile/Rules/Mitigations/NavToMitigations_CreateRisks.js */ "./build.definitions/RiskMobile/Rules/Mitigations/NavToMitigations_CreateRisks.js")
let riskmobile_rules_mitigations_navtomitigations_edit_js = __webpack_require__(/*! ./RiskMobile/Rules/Mitigations/NavToMitigations_Edit.js */ "./build.definitions/RiskMobile/Rules/Mitigations/NavToMitigations_Edit.js")
let riskmobile_rules_risks_navtorisks_edit_js = __webpack_require__(/*! ./RiskMobile/Rules/Risks/NavToRisks_Edit.js */ "./build.definitions/RiskMobile/Rules/Risks/NavToRisks_Edit.js")
let riskmobile_rules_risks_risks_cancel_js = __webpack_require__(/*! ./RiskMobile/Rules/Risks/Risks_Cancel.js */ "./build.definitions/RiskMobile/Rules/Risks/Risks_Cancel.js")
let riskmobile_rules_risks_risks_createentity_js = __webpack_require__(/*! ./RiskMobile/Rules/Risks/Risks_CreateEntity.js */ "./build.definitions/RiskMobile/Rules/Risks/Risks_CreateEntity.js")
let riskmobile_rules_risks_risks_deleteconfirmation_js = __webpack_require__(/*! ./RiskMobile/Rules/Risks/Risks_DeleteConfirmation.js */ "./build.definitions/RiskMobile/Rules/Risks/Risks_DeleteConfirmation.js")
let riskmobile_rules_risks_risks_updateentity_js = __webpack_require__(/*! ./RiskMobile/Rules/Risks/Risks_UpdateEntity.js */ "./build.definitions/RiskMobile/Rules/Risks/Risks_UpdateEntity.js")
...
module.exports = {
	...
	riskmobile_actions_mitigations_mitigations_createentity_action : riskmobile_actions_mitigations_mitigations_createentity_action,
	riskmobile_actions_mitigations_mitigations_createrisks_action : riskmobile_actions_mitigations_mitigations_createrisks_action,
	riskmobile_actions_mitigations_mitigations_deleteentity_action : riskmobile_actions_mitigations_mitigations_deleteentity_action,
	riskmobile_actions_mitigations_mitigations_detailpopover_action : riskmobile_actions_mitigations_mitigations_detailpopover_action,
	riskmobile_actions_mitigations_mitigations_updateentity_action : riskmobile_actions_mitigations_mitigations_updateentity_action,
	riskmobile_actions_mitigations_navtomitigations_create_action : riskmobile_actions_mitigations_navtomitigations_create_action,
	riskmobile_actions_mitigations_navtomitigations_createrisks_action : riskmobile_actions_mitigations_navtomitigations_createrisks_action,
	riskmobile_actions_mitigations_navtomitigations_detail_action : riskmobile_actions_mitigations_navtomitigations_detail_action,
	riskmobile_actions_mitigations_navtomitigations_edit_action : riskmobile_actions_mitigations_navtomitigations_edit_action,
	riskmobile_actions_mitigations_navtomitigations_list_action : riskmobile_actions_mitigations_navtomitigations_list_action,
	riskmobile_actions_risks_navtorisks_create_action : riskmobile_actions_risks_navtorisks_create_action,
	riskmobile_actions_risks_navtorisks_detail_action : riskmobile_actions_risks_navtorisks_detail_action,
	riskmobile_actions_risks_navtorisks_edit_action : riskmobile_actions_risks_navtorisks_edit_action,
	riskmobile_actions_risks_navtorisks_list_action : riskmobile_actions_risks_navtorisks_list_action,
	riskmobile_actions_risks_risks_createentity_action : riskmobile_actions_risks_risks_createentity_action,
	riskmobile_actions_risks_risks_deleteentity_action : riskmobile_actions_risks_risks_deleteentity_action,
	riskmobile_actions_risks_risks_updateentity_action : riskmobile_actions_risks_risks_updateentity_action,
	riskmobile_actions_service_initializeonline_action : riskmobile_actions_service_initializeonline_action,
	riskmobile_actions_service_initializeonlinefailuremessage_action : riskmobile_actions_service_initializeonlinefailuremessage_action,
	riskmobile_actions_service_initializeonlinesuccessmessage_action : riskmobile_actions_service_initializeonlinesuccessmessage_action,
	...
	riskmobile_pages_mitigations_mitigations_create_page : riskmobile_pages_mitigations_mitigations_create_page,
	riskmobile_pages_mitigations_mitigations_createrisks_page : riskmobile_pages_mitigations_mitigations_createrisks_page,
	riskmobile_pages_mitigations_mitigations_detail_page : riskmobile_pages_mitigations_mitigations_detail_page,
	riskmobile_pages_mitigations_mitigations_edit_page : riskmobile_pages_mitigations_mitigations_edit_page,
	riskmobile_pages_mitigations_mitigations_list_page : riskmobile_pages_mitigations_mitigations_list_page,
	riskmobile_pages_risks_risks_create_page : riskmobile_pages_risks_risks_create_page,
	riskmobile_pages_risks_risks_detail_page : riskmobile_pages_risks_risks_detail_page,
	riskmobile_pages_risks_risks_edit_page : riskmobile_pages_risks_risks_edit_page,
	riskmobile_pages_risks_risks_list_page : riskmobile_pages_risks_risks_list_page,
	...
	riskmobile_rules_mitigations_mitigations_cancel_js : riskmobile_rules_mitigations_mitigations_cancel_js,
	riskmobile_rules_mitigations_mitigations_createentity_js : riskmobile_rules_mitigations_mitigations_createentity_js,
	riskmobile_rules_mitigations_mitigations_createrisks_js : riskmobile_rules_mitigations_mitigations_createrisks_js,
	riskmobile_rules_mitigations_mitigations_deleteconfirmation_js : riskmobile_rules_mitigations_mitigations_deleteconfirmation_js,
	riskmobile_rules_mitigations_mitigations_updateentity_js : riskmobile_rules_mitigations_mitigations_updateentity_js,
	riskmobile_rules_mitigations_navtomitigations_createrisks_js : riskmobile_rules_mitigations_navtomitigations_createrisks_js,
	riskmobile_rules_mitigations_navtomitigations_edit_js : riskmobile_rules_mitigations_navtomitigations_edit_js,
	riskmobile_rules_risks_navtorisks_edit_js : riskmobile_rules_risks_navtorisks_edit_js,
	riskmobile_rules_risks_risks_cancel_js : riskmobile_rules_risks_risks_cancel_js,
	riskmobile_rules_risks_risks_createentity_js : riskmobile_rules_risks_risks_createentity_js,
	riskmobile_rules_risks_risks_deleteconfirmation_js : riskmobile_rules_risks_risks_deleteconfirmation_js,
	riskmobile_rules_risks_risks_updateentity_js : riskmobile_rules_risks_risks_updateentity_js,
...
module.exports = {"_Name":"RiskMobile","Version":"/RiskMobile/Globals/Application/AppDefinition_Version.global","MainPage":"/RiskMobile/Pages/Main.page","OnLaunch":["/RiskMobile/Actions/Service/InitializeOnline.action"],"OnWillUpdate":"/RiskMobile/Rules/Application/OnWillUpdate.js","OnDidUpdate":"/RiskMobile/Actions/Service/InitializeOnline.action","Styles":"/RiskMobile/Styles/Styles.less","Localization":"/RiskMobile/i18n/i18n.properties","_SchemaVersion":"23.12","StyleSheets":{"Styles":{"css":"/RiskMobile/Styles/Styles.css","ios":"/RiskMobile/Styles/Styles.nss","android":"/RiskMobile/Styles/Styles.json"}}}
...
/***/ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_CreateEntity.action":
/*!******************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_CreateEntity.action ***!
  \******************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_CreateRisks.action":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_CreateRisks.action ***!
  \*****************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_DeleteEntity.action":
/*!******************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_DeleteEntity.action ***!
  \******************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_DetailPopover.action":
/*!*******************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_DetailPopover.action ***!
  \*******************************************************************************************/
/***/ ((module) => {

module.exports = {"PopoverItems":[{"Title":"Add Risks","OnPress":"/RiskMobile/Rules/Mitigations/NavToMitigations_CreateRisks.js"},{"Title":"Delete","OnPress":"/RiskMobile/Rules/Mitigations/Mitigations_DeleteConfirmation.js"}],"_Type":"Action.Type.PopoverMenu"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_UpdateEntity.action":
/*!******************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/Mitigations_UpdateEntity.action ***!
  \******************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Create.action":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Create.action ***!
  \*****************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/Mitigations/Mitigations_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_CreateRisks.action":
/*!**********************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_CreateRisks.action ***!
  \**********************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/Mitigations/Mitigations_CreateRisks.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Detail.action":
/*!*****************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Detail.action ***!
  \*****************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RiskMobile/Pages/Mitigations/Mitigations_Detail.page"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Edit.action":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_Edit.action ***!
  \***************************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/Mitigations/Mitigations_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_List.action":
/*!***************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Mitigations/NavToMitigations_List.action ***!
  \***************************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RiskMobile/Pages/Mitigations/Mitigations_List.page"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Create.action":
/*!*****************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Create.action ***!
  \*****************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/Risks/Risks_Create.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Detail.action":
/*!*****************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Detail.action ***!
  \*****************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RiskMobile/Pages/Risks/Risks_Detail.page"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Edit.action":
/*!***************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Risks/NavToRisks_Edit.action ***!
  \***************************************************************************/
/***/ ((module) => {

module.exports = {"ModalPageFullscreen":false,"ModalPage":true,"PageToOpen":"/RiskMobile/Pages/Risks/Risks_Edit.page","_Type":"Action.Type.Navigation"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Risks/NavToRisks_List.action":
/*!***************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Risks/NavToRisks_List.action ***!
  \***************************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.Navigation","PageToOpen":"/RiskMobile/Pages/Risks/Risks_List.page"}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Risks/Risks_CreateEntity.action":
/*!******************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Risks/Risks_CreateEntity.action ***!
  \******************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/Risks/Risks_DeleteEntity.action":
/*!******************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Risks/Risks_DeleteEntity.action ***!
  \******************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/Risks/Risks_UpdateEntity.action":
/*!******************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Risks/Risks_UpdateEntity.action ***!
  \******************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/Service/InitializeOnline.action":
/*!******************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Service/InitializeOnline.action ***!
  \******************************************************************************/
/***/ ((module) => {

module.exports = {"Service":"/RiskMobile/Services/service1.service","_Type":"Action.Type.ODataService.Initialize","ShowActivityIndicator":true,"OnSuccess":"/RiskMobile/Actions/Service/InitializeOnlineSuccessMessage.action","OnFailure":"/RiskMobile/Actions/Service/InitializeOnlineFailureMessage.action","ActionResult":{"_Name":"init"}}

/***/ }),

/***/ "./build.definitions/RiskMobile/Actions/Service/InitializeOnlineFailureMessage.action":
/*!********************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Service/InitializeOnlineFailureMessage.action ***!
  \********************************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RiskMobile/Actions/Service/InitializeOnlineSuccessMessage.action":
/*!********************************************************************************************!*\
  !*** ./build.definitions/RiskMobile/Actions/Service/InitializeOnlineSuccessMessage.action ***!
  \********************************************************************************************/
/***/ ((module) => {
